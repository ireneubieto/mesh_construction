...
async function main() {
    ...
    document.getElementById("adjust-btn").addEventListener("click", function () {
        ...
        document.getElementById("adjust-guide").style.display = "none";
        document.getElementById("adjust").style.display = "none";
        document.getElementById("canvas").style.display = "block";
        document.getElementById("edit-btn").style.display = "block";
        document.getElementById("edit-guide").style.display = "block";
        initScene();
        render();
    })
    document.getElementById("edit-btn").addEventListener("click", function () {
        ...
        document.getElementById("edit-guide").style.display = "none";
